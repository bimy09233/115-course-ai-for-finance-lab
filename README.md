...
本專案整理「人工智慧金融投資決策」課程作業與實作練習。各作業會依序放在 `HW1/`、`HW2/`、`HW3/`、`HW4/` 等目錄中，根目錄 README 作為專案總覽、環境建置與執行入口索引。
...
| HW4 | 二項樹、Black-Scholes 與 Monte Carlo 選擇權定價。 | [`HW4/README.md`](HW4/README.md) |
